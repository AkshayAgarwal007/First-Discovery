FDOP.Levels = function(game){
    this.unlock=[];
};
FDOP.Levels.prototype = {
	create: function(){
        ...
        lwindow= this.add.sprite(FDOP.GAME_WIDTH/2, FDOP.GAME_HEIGHT/2,'lwindow');
        lwindow.anchor.setTo(0.5,0.5);
        lwindow.scale.setTo(1.1,1);
        
        levels= this.add.sprite(FDOP.GAME_WIDTH/2, FDOP.GAME_HEIGHT-lwindow.width/2-100,'levels');
        levels.anchor.setTo(0.5,0.5);
        levels.scale.setTo(0.58,0.58);
        
        left_btn= this.add.button(FDOP.GAME_WIDTH/2+lwindow.width/2-40, FDOP.GAME_HEIGHT/2,'right_btn',this.clickDisabled,this);
        ...
        right_btn= this.add.button(FDOP.GAME_WIDTH/2-lwindow.width/2+40, FDOP.GAME_HEIGHT/2,'left_btn',this.clickDisabled,this);
        ...
        close_btn= this.add.button(FDOP.GAME_WIDTH/2+lwindow.width/2-75, FDOP.GAME_HEIGHT/2-245,'close_btn',this.backtoMenu,this);
        ...
        for (var i=2;i<3;++i)
        {
        this.unlock[i-2]= this.add.button(FDOP.GAME_WIDTH/2-90+200*i, FDOP.GAME_HEIGHT/2-85,'unlock',this.clickDisabled,this);
        ...
        for (var i=0;i<4;++i)
        {
        this.unlock[i+1]= this.add.button(FDOP.GAME_WIDTH/2-290+200*i, FDOP.GAME_HEIGHT/2+95,'unlock',this.clickDisabled,this);
        ...
        level1= this.add.button(FDOP.GAME_WIDTH/2-290, FDOP.GAME_HEIGHT/2-85,'level1',function() {this.startGame(1)} ,this);
        level1.alpha=0.8;
        ...
        level2= this.add.button(FDOP.GAME_WIDTH/2-90+200*0, FDOP.GAME_HEIGHT/2-85,'level2',function() {this.startGame(2)},this);
        level2.alpha=0.8;
        ...
        level3= this.add.button(FDOP.GAME_WIDTH/2-90+200*1, FDOP.GAME_HEIGHT/2-85,'level3',function() {this.startGame(3)},this);
        level3.alpha=0.8;
        ...
        var ground = platforms.create(0, FDOP.GAME_HEIGHT - 92, 'layer4');
