FDOP.Game2 = function(game){
    ...
    this.nosprite=false;
    this.count=9;
    this.speed={1:60,2:70,3:80,4:90};
    this.levelChange=false;
    this.finishGame=false;
};

FDOP.Game2.prototype = {
	create: function(){
        ...
        player = this.add.sprite(250,FDOP.GAME_HEIGHT-220,'player');
        ...
        sprite = this.add.sprite(this.spawnx, FDOP.GAME_HEIGHT-150, 'enem');
        ...
        dialog = this.add.sprite(sprite.position.x-20,FDOP.GAME_HEIGHT-225,'dialog');
    	dialog.scale.setTo(0.24,0.24);
        quesText = this.add.text(sprite.position.x+10,FDOP.GAME_HEIGHT-212 , this.generateQuestion(), { fontSize: '45px', fill: '#000' });
    ...
    {
        changeText = this.add.text(FDOP.GAME_WIDTH/2,FDOP.GAME_HEIGHT/2 , "Level Complete !", { fontSize: '72px', fill: '#000' });
    ...
    gameOver: function()
    {
        finishText = this.add.text(FDOP.GAME_WIDTH/2,FDOP.GAME_HEIGHT/2 , "Congrats! All levels Completed..", { fontSize: '28px', fill: '#000' });
